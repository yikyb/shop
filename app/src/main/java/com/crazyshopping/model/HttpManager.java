package com.crazyshopping.model;

import android.util.Log;


import com.crazyshopping.common.Constans;
import com.crazyshopping.model.api.ShopApi;
import com.crazyshopping.utils.DigestUtils;
...
public class HttpManager {
    ...
    private static OkHttpClient getOkHttpClient() {
        File file = new File(Constans.PATH_CACHE);
    ...
    private static String signUrl = "wdwan.cn"; //需要签名的域名
    ...
    public ShopApi getShopApi() {
        if (shopApi == null) {
            shopApi = getRetrofit(Constans.Base_Url).create(ShopApi.class);
        }
        return shopApi;
    }
